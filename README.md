...
1. [Selecting Elements](#1️⃣-selecting-elements)
2. [Creating & Inserting Elements](#2️⃣-creating--inserting-elements)
3. [Removing & Replacing Elements](#3️⃣-removing--replacing-elements)
4. [Modifying Element Content](#4️⃣-modifying-element-content)
5. [Working with Attributes](#5️⃣-working-with-attributes)
6. [Manipulating Classes](#6️⃣-manipulating-classes)
7. [Inline Styles](#7️⃣-inline-styles)
8. [Traversing the DOM](#8️⃣-traversing-the-dom)
9. [Event Handling](#9️⃣-event-handling)
10. [Event Object Properties](#🔟-event-object-properties)
11. [Common Event Types](#1️⃣1️⃣-common-event-types)
12. [Form Events & Handling](#1️⃣2️⃣-form-events--handling)
13. [Document & Window Events](#1️⃣3️⃣-document--window-events)
14. [Mouse & Pointer Events](#1️⃣4️⃣-mouse--pointer-events)
15. [Keyboard Events](#1️⃣5️⃣-keyboard-events)
16. [Touch Events](#1️⃣6️⃣-touch-events)
17. [Drag & Drop API](#1️⃣7️⃣-drag--drop-api)
18. [Intersection Observer API](#1️⃣8️⃣-intersection-observer-api)
19. [Mutation Observer API](#1️⃣9️⃣-mutation-observer-api)
20. [Resize Observer API](#2️⃣0️⃣-resize-observer-api)
21. [Web Storage API](#2️⃣1️⃣-web-storage-api)
22. [Clipboard API](#2️⃣2️⃣-clipboard-api)
23. [Geolocation API](#2️⃣3️⃣-geolocation-api)
24. [Fetch API](#2️⃣4️⃣-fetch-api)
25. [DOM Manipulation Performance Tips](#2️⃣5️⃣-dom-manipulation-performance-tips)
